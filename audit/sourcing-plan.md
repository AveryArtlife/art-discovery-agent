...
| `open_cycle_tension` | Continuous rising shimmer + filtered-noise sweep | Synthesise | Synthesise in-house: Filtered-noise sweep + granular smear of the pass glints, resolving toward E6 | Owned | No | Yes | Yes | Designer time | Primary |
